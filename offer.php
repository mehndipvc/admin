                ...
                <div class="page-header">
                    <div class="row align-items-center">
                        ...
                        <div class="col-auto float-right ml-auto">
                            <a href="#" class="btn add-btn" data-toggle="modal" data-target="#add_holiday"><i class="fa fa-plus"></i> Set Offer</a>
                        </div>
                    </div>
                </div>
                <!-- /Page Header -->
                            ...
                            <table class="table table-striped custom-table mb-0" id="offer-table">
                                ...
                                <tbody>
                                    ...
                                    ?>
                                            ...
                                            <td class="text-right">
                                                <div class="dropdown dropdown-action">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right">
                                                        <a class="dropdown-item" href="#" data-toggle="modal" data-target="#edit_offer<?php echo $cnt; ?>"><i class="fa fa-pencil m-r-5"></i> Edit</a>
                                        ...
                                        <!-- Edit Offer Modal -->
                                        <div class="modal custom-modal fade" id="edit_offer<?php echo $cnt; ?>" role="dialog">
                                                        ...
                                                        <form id="edit_form<?php echo $cnt; ?>" enctype="multipart/form-data">
                                                            <div class="form-group">
                                                                ...
                                                                <select name="product_id" class="form-control" id="product_det">
                                                                    ...
                                                                    ?>
                                                                        <option value="<?= $pro_val['id'] ?>" <?= ($pro_val['id']==$val['item_id'])?'selected':'';?>><?= $pro_val['name'] ?></option>
                                                                    <?php } ?>
                                                                </select>
                                                            </div>
                                                            <div class="form-group">
                                                                ...
                                                                <select name="offer_type" id="offer_type" class="form-control">
                                                                    <option value="Price" <?= ($val['discount_type']=='Price')?'selected':'';?>>Price</option>
                                                                    <option value="Percentage" <?= ($val['discount_type']=='Percentage')?'selected':'';?>>Percentage</option>
                                                                </select>
                                                            </div>
                                                            <div class="form-group price" id="pri_div">
                                                                <label>Offer </label>
                                                                <input class="form-control" type="text" name="offer" id="offer" value="<?= $val['amount'] ?>"/>
                                                            </div>
                            
                                                            <div class="submit-section">
                                                                <input class="form-control" type="hidden" name="id" id="id" value="<?= $val['id'] ?>"/>
                                                                <button type="submit" name="" class="btn btn-primary submit-btn" id="edit_offer_btn">
                                                                    Submit
                                                                </button>
                                                            </div>
