                                                            ...
                                                            <div class="row">
                                                                <div class="col-6">
                                                                    ...
                                                                    <button class="btn btn-primary continue-btn"
                                                                        value="<?php echo $val['item_id']; ?>"
                                                                        id="dlt_btn<?php echo $val['item_id']; ?>"
                    ...
                    <nav aria-label="Page navigation example">
                        ...
                        <ul class="pagination">
                            ...
                            <li class="page-item <?php if ($page == 1)
                                echo 'disabled'; ?>">
                                <a class="page-link"
                                    href="<?= $page_param ? '?' . $page_param . '&page=' . max($prev_page, 1) : '?page=' . max($prev_page, 1) ?>">Previous</a>
                            </li>
                            ...
                            <li class="page-item <?php if ($page == $total_pages)
                                echo 'disabled'; ?>">
                                <a class="page-link"
                                    href="<?= $page_param ? '?' . $page_param . '&page=' . min($next_page, $total_pages) : '?page=' . min($next_page, $total_pages) ?>">Next</a>
                            </li>
                        </ul>
                            ...
                            <form id="add_category_form">
                                ...
                                <div class="submit-section">
                                    <button type="submit" name="edit" class="btn btn-primary submit-btn"
                                        id="submitGallery">Submit</button>
                                </div>
