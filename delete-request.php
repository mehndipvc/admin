         ...
         <div class="page-wrapper">
             ...
             <div class="content container-fluid">
                 ...
                 <div class="page-header">
                     <div class="row align-items-center">
                         <div class="col">
                             <h3 class="page-title">Delete Request</h3>
                             <ul class="breadcrumb">
                                 <li class="breadcrumb-item"><a href="dashboard.php">Dashboard</a></li>
                                 <li class="breadcrumb-item active">Delete Request</li>
                             </ul>
                         </div>
                 ...
                 <div class="row">
                     <div class="col-md-12">
                         <div class="table-responsive">
                             <table class="table table-striped custom-table mb-0" id="rate-chart-table">
                                 <thead>
                                     <tr>
                                         <th>#</th>
                                         <th>User Name</th>
                                 ...
                                 <tbody>
                                     <?php
                                        $cnt = '0';
                                        $selct = $obj->fetch("SELECT * FROM `account_del_req` ORDER BY id DESC");
                                        foreach ($selct as $val) {
                                         ...
                                         <tr class="holiday-upcoming">
                                             ...
                                             <td><?= $val['user_name'] ?></td>
                                             <td><?= $sel_user['name'] ?></td>
                                             <td><?= $val['is_approve']==''?'Pending':'User Deleted' ?></td>

                                             <td class="text-right">
                                                 <div class="dropdown dropdown-action">
                                                     <a href="#" class="action-icon dropdown-toggle" data-toggle="dropdown" aria-expanded="false"><i class="material-icons">more_vert</i></a>
                                                     <div class="dropdown-menu dropdown-menu-right">
                                                         <a class="dropdown-item" href="#" data-toggle="modal" data-target="#delete_holiday<?php echo $cnt; ?>"><i class="fa fa-check m-r-5"></i> Accept</a>
                                                     </div>
                                                 </div>
                                             </td>
                                         </tr>
                                             ...
                                             <div class="modal-dialog modal-dialog-centered" role="document">
                                                 <div class="modal-content">
                                                     <div class="modal-header">
                                                         <h5 class="modal-title">Edit Rate Chart</h5>
                                                         <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                             <span aria-hidden="true">&times;</span>
                                                         </button>
                                                     </div>
                                                     <div class="modal-body">
                                                         <form class="edit_ratechart" id="<?= $val['id'] ?>">
                                                             <div class="form-group">
                                                                 <label>Chart Name <span class="text-danger">*</span></label>
                                                                 <input id="menu<?php echo $val['id']; ?>" class="form-control" value="<?php echo $val['name']; ?>" type="text" name="menu" />
                                                             ...
                                                             <div class="form-group">
                                                                 ...
                                                                 <select class="form-control" name="user_id" required>
                                                                     ...
                                                                     <?php
                                                                     if($val_user['user_id']=='All User'){
                                                                         echo '<option value="All User" selected>All User</option>';
                                                                     }else{
                                                                         echo '<option value="All User">All User</option>';
                                                                     }
                                                                     
                                                                     $sel_user=$obj->fetch("SELECT * FROM `users`");
                                                                     foreach($sel_user as $val_user){
                                                                     ?>
                                                                     
                                                                     <option value="<?=$val_user['user_id']?>" <?=($val_user['user_id']==$val['user_id'])?'selected':''?> > <?=$val_user['name']?> </option>
                                                             ...
                                                             <div class="submit-section">
                                                                ...
                                                                <input type="hidden" value="<?= $val['file_path'] ?>" name="old_file">
                                                 ...
                                                 <div class="modal-content">
                                                     <div class="modal-body">
                                                         <div class="form-header">
                                                             <h3>Delete User</h3>
                                                             <p>Are you sure want to accept the delete request?</p> 
                                                         </div>
             ...
             <div class="modal custom-modal fade" id="add_holiday" role="dialog">
                 <div class="modal-dialog modal-dialog-centered" role="document">
                     <div class="modal-content">
                         <div class="modal-header">
                             <h5 class="modal-title">Upload Rate Chart</h5>
                             <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                 <span aria-hidden="true">&times;</span>
                             </button>
                         </div>
                         <div class="modal-body">
                             <form id="add_category">
                                 ...
                                 <div class="form-group">
                                     <label>Select User <span class="text-danger">*</span></label>
                                     <select class="form-control" name="user_id" required>
                                         <option value="">--Selct User--</option>
                                         <option value="All User">All User</option>
                                         <?php
                                         $sel_user=$obj->fetch("SELECT * FROM `users`");
                                         foreach($sel_user as $val_user){
                                         ?>
                                         <option value="<?=$val_user['user_id']?>"><?=$val_user['name']?></option>
                                         <?php } ?>
                                     </select>
                                 </div>
                                 <div class="form-group">
                                     <label>Chart File <span class="text-danger">*</span></label>
 ...
 <script>
    $('#add_category').on("submit", function(e){
        e.preventDefault();
        $.ajax({
            url:"upload-ratechart-submit.php",
            type:"post",
...
<script>
    $('.edit_ratechart').on("submit", function(e){
        e.preventDefault();
        const id = $(this).attr('id');

        $.ajax({
            url: "edit-rateChart.php",
            type: "post",
            data:new FormData(this),
            cache: false,
            contentType: false,
     ...
     $(document).ready(function(){
          var table = $('#rate-chart-table').DataTable({
            "searching": true
        });
     });
</script>