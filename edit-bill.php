                                ...
                                <div class="col-sm-2">
                                    ...
                                    <div class="form-group">
                                        <input type="text" name="terms_del" id="" class="form-control"
                                            value="<?= $data['terms_del'] ?>">
                                        <input type="hidden" name="invo_no" id="invo_no" class="form-control"
                                            value="<?= $data['invo_no'] ?>">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                    ...
                                    <table style="height:150px;width:100%;border:1px solid black"
                                        ...
                                        <tbody>
                                            ...
                                            foreach ($dtls_qr as $val) {
                                                ...
                                                <tr id="row_cnt<?= $cnt ?>">
                                                    <td><?= $cnt ?></td>
                                                    <td><input type="text" name="service[]" value="<?= $val['service'] ?>">
                                                    </td>
                                                    <td><input type="text" style="width: 50px;" id="item<?= $cnt ?>"
                                                            name="item[]" class="calculate" value="<?= $val['item'] ?>">
                                                    </td>
                                                    <td><input type="text" style="width: 100px;" id="price<?= $cnt ?>"
                                                            name="price[]" class="calculate" value="<?= $val['price'] ?>">
                                                    </td>
                                                    <td><input type="text" style="width: 50px;" id="dis_rate<?= $cnt ?>"
                                                            name="dis_rate[]" class="calculate"
                                                            value="<?= $val['dis_rate'] ?>"></td>
                                                    <td><input type="text" style="width: 80px;" id="dis_amt<?= $cnt ?>"
                                                            name="dis_amt[]" class="calculate" readonly
                                                            value="<?= $val['dis_amt'] ?>"></td>
                                                    <td><input type="text" style="width: 50px;" id="cgst_rate<?= $cnt ?>"
                                                            name="cgst_rate[]" class="calculate"
                                                            value="<?= $val['cgst_rate'] ?>"></td>
                                                    <td><input type="text" style="width: 80px;" id="cgst_amt<?= $cnt ?>"
                                                            name="cgst_amt[]" class="calculate" readonly
                                                            value="<?= $val['cgst_amt'] ?>"></td>
                                                    <td><input type="text" style="width: 50px;" id="sgst_rate<?= $cnt ?>"
                                                            name="sgst_rate[]" class="calculate"
                                                            value="<?= $val['sgst_rate'] ?>"></td>
                                                    <td><input type="text" style="width: 80px;" id="sgst_amt<?= $cnt ?>"
                                                            name="sgst_amt[]" class="calculate" readonly
                                                            value="<?= $val['sgst_amt'] ?>"></td>
                                                    <td><input type="text" style="width: 100px;" id="total<?= $cnt ?>"
                                                            name="total[]" readonly value="<?= $val['total'] ?>"></td>
                                                    <td><input type="hidden" value="<?= $val['id'] ?>" name="bill_dtl_id[]">
                                                    </td>
                                                    <td><button class="btn btn-danger" id="remove_row<?= $cnt ?>"><i
                                ...
                                <div class="col-sm-12">
                                    <div class="text-right pr-18">
                                        <b class="text-right">Total Amount: </b><span
                                            id="final_amt"><?= $data['final_amt'] ?></span>
                                    </div>
