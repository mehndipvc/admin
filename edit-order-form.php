                    ...
                    <div class="col-md-12">
                       <form id="edit_order_form">
                                    ...
                                    ?>
                                        <div class="form-group text-left col-sm-6">
                                            ...
                                            <select class="form-control product-select" name="pro_id[]" required>
                                                ...
                                                ?>
                                                    <option value="<?= $val_pro['id'] ?>" data-price="<?= $price_new ?>" <?= ($item_id == $val_pro['id']) ? 'selected' : '' ?>>
                                                        <?= $val_pro['name'] ?>
                                                    </option>
                                                <?php
                                                }
                                        ...
                                        <div class="form-group text-left col-sm-6">
                                            <div class="row">
                                                <div class="col-sm-6">
                                                <label>Qty</label>
                                                <input type="text" class="form-control quantity" value="<?= $val_item['quantity'] ?>" name="quantity[]">
                                            </div>
                                            <div class="col-sm-6">
                                                <label>Price</label>
                                                <input type="text" class="form-control price" id="price<?=$procount?>" value="<?=$price?>" readonly>
                                            </div>
                                            </div>
                                        </div>
                                    <?php
                            ...
                            <div class="form-group text-right" style="font-size:18px">
                                ...
                                <span style="font-family:cambria">&#8377;</span> <span id="totalAmount" style="color: blue;"><?= $total_amount ?></span>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <button type="submit" class="btn btn-primary mx-auto continue-btn editSubmit" id="<?php echo $val['order_id']; ?>">Submit</button>
                            </div>
