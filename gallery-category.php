                 ...
                 <div class="page-header">
                     <div class="row align-items-center">
                         ...
                         <div class="col-auto float-right ml-auto">
                             <a href="#" class="btn add-btn" data-toggle="modal" data-target="#add_holiday"><i class="fa fa-plus"></i> Add Category</a>
                         </div>
                     </div>
                 </div>
                 <!-- /Page Header -->
                 ...
                 <div class="row">
                     <div class="col-md-12">
                         <div class="table-responsive">
                             <table class="table table-striped custom-table mb-0" id="gallery-category-table">
                                 <thead>
                                     <tr>
                                         <th>#</th>
                                 ...
                                 <tbody>
                                     <?php
                                        $cnt = '0';
                                        $selct = $obj->fetch("SELECT * FROM `gal_category` ORDER BY id DESC");
                                                     ...
                                                     <div class="modal-body">
                                                         <form class="edit_category" id="<?= $val['id'] ?>">
                                                             <div class="form-group">
                                                                 ...
                                                                 <input id="menu<?php echo $val['id']; ?>" class="form-control" value="<?php echo $val['category']; ?>" type="text" name="category" />
                                                                 <span class="preview2"></span>
                                                             </div>
                                                              <div class="form-group">
                                                                 <label>Image <span class="text-danger">*</span></label>
                                                                 <input class="form-control" type="file" name="image" id="image" />
                                                                 <input type="hidden" value="<?=$val['image']?>" name="old_img">
                                                             </div>
...
<script>
    ...
    $(document).ready(function(){
      var table = $('#gallery-category-table').DataTable({
        "searching": true
      });
    });
</script>