                 ...
                 <div class="page-header">
                     <div class="row align-items-center">
                         ...
                         <div class="col-auto float-right ml-auto">
                             <a href="#" class="btn add-btn" data-toggle="modal" data-target="#add_holiday"><i class="fa fa-plus"></i> Upload Chart</a>
                         </div>
                     </div>
                 </div>
                 <!-- /Page Header -->
                         ...
                         <div class="table-responsive">
                             <table class="table table-striped custom-table mb-0" id="rate-chart-table">
                                 ...
                                 <tbody>
                                     <?php
                                        $cnt = '0';
                                        $selct = $obj->fetch("SELECT * FROM `rate_chart` ORDER BY id DESC");
                                        foreach ($selct as $val) {
                                            $cnt++; ?>
                                         <tr class="holiday-upcoming">
                                             <td><?php echo $cnt; ?></td>
                                             <td><?php
                                             if($user_id=$val['user_id']=='All User'){
                                                 echo 'All User';
                                             }else{
                                                 $user_id=$val['user_id'];
                                             ...
                                             <td><a href="<?=  $val['file'] ?>">Download</a></td>
