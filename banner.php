                        ...
                        <div class="table-responsive">
                            <table class="table table-striped datatable custom-table mb-0" id="banner-load">
                                ...
                                <tbody>
                                    <?php
                                    $cnt = '0';
                                    $selct = $obj->fetch("SELECT * FROM banners ORDER BY id DESC");
                                    foreach ($selct as $val) {
                                        $cnt++;
                                        $old = $val['filename']; ?>
                                        <tr class="holiday-upcoming">
                                            <td><?php echo $cnt; ?></td>
                                            <td><img src="<?php echo $assetImgUrl . $val['filename']; ?>"
                                                ...
                                                <div class="dropdown dropdown-action">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right">
                                                        <a class="dropdown-item" href="#" data-toggle="modal"
                                                            data-target="#edit_banner_modal<?php echo $cnt; ?>"><i
                                        ...
                                        <!-- Edit banner Modal -->
                                        <div class="modal custom-modal fade" id="edit_banner_modal<?php echo $cnt; ?>"
                                            role="dialog">
                                                    ...
                                                    <div class="modal-body">
                                                        <form id="edit_banner<?php echo $cnt; ?>">
                                                            <div class="form-group">
                                                                ...
                                                                <img class="thumbnail" id="img"
                                                                    src="<?php echo $assetImgUrl . $val['filename']; ?>"
                                                                    style="width: 100px;" />
                                                                <input id="image<?php echo $val['id']; ?>"
                                                                    class="form-control file" type="file"
                                                                    style="margin-top: 10px;" name="image" />
                                                                <input type="hidden" name="old_image"
                                                                    value="<?php echo $assetImgUrl . $val['filename']; ?>"
                                                                    id="old_image" />
                                                            ...
                                                            <div class="row">
                                                                <div class="col-12" align="center"
                                                                    style="padding-top: 15px;"><span
                                                                        id="previewmsg<?php echo $val['id']; ?>"></span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form id="fupForm" enctype="multipart/form-data">
                                ...
                                <div class="submit-section">
                                    <input type="submit" name="edit" class="btn btn-primary submit-btn" id="submit"
                                        value="Submit" />
                                </div>
