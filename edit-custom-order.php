                            ...
                            <form id="edit_doctor" enctype="multipart/form-data">
                               ...
                               <div class="row">
                                   ...
                                   <div class="col-md-6">
                                       <div class="form-group">
                                         ...
                                         <select class="form-control" name="user_id" id="user-select" required><br>
                                             ...
                                             <?php
                                                ...
                                                ?>
                                                 <option value="<?= $cval['user_id'] ?>" <?=$val_order['user_id']==$cval['user_id']?'selected':'' ?>><?= $cval['name'] ?> [<?= $cval['user_type'] ?>]</option>
                                             <?php  } ?>
                                         </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                       <div class="form-group">
                                         ...
                                         <input class="form-control" value="<?=$val_order['price']?>" name="total_amount" id="total_amount" type="number" required>
                                        </div>
                                    </div>
                                ...
                                <div id="user-inputs">
                                    ...
                                    <div class="form-group col-sm-6">
                                        ...
                                        <div class="custom-field-parent">
                                            <input type="number" value="<?=($sel_commission['amount']/$val_order['price'])*100?>" class="form-control custom-input" oninput="calculate(this,<?=$parent_val['user_id']?>)" name="percentage[]" placeholder="Enter Percentage">
                                            <input readonly type="number" value="<?=$sel_commission['amount']?>" class="form-control custom-input" id="par-com<?=$parent_val['user_id']?>" name="par-com[]" placeholder="Commission Amount">
                                        </div>
                                        <input type="hidden" class="form-control" name="parent_ids[]" value="<?=$parent_val['user_id']?>">
                                    </div>
                                    <?php } } ?>
                                    </div>
                                </div>
                                ...
                                <div class="submit-section">
                                    ...
                                    <input type="hidden" class="form-control" name="old_invoice" value="<?=$val_order['invoice_path']?>">
                                    <input type="hidden" class="form-control" name="old_invoice_temp" value="<?=$val_order['temp_path']?>">
