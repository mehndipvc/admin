                         ...
                         <div class="table-responsive">
                             <table class="table table-striped custom-table mb-0" id="rate-chart-table">
                                 ...
                                 <tbody>
                                     <?php
                                        $cnt = 0;
                                        $selct = $obj->fetch("SELECT * FROM `leads` ORDER BY id DESC");
                                        ...
                                        ?>
                                         <tr class="holiday-upcoming">
                                            ...
                                            <td>
                                                ...
                                                if(!empty($val['image'])){
                                                ?>
                                                <a href="https://app.pvcinterior.in/<?= $val['image'] ?>" data-fancybox="gallery" data-caption="Image caption here">
                                                    <img class="img-thumbnail" width="100" src="https://app.pvcinterior.in/<?= $val['image'] ?>" alt="Thumbnail">
                                                </a>
                                                <?php } ?>
                                            </td>
                                            <td><?= $val['address'] ?></td>
                                            ...
                                            <td class="text-right">
                                                 <div class="dropdown dropdown-action">
                                                     ...
                                                     <div class="dropdown-menu dropdown-menu-right">
                                                         <a class="dropdown-item" href="#" data-toggle="modal" data-target="#delete_holiday<?php echo $cnt; ?>"><i class="fa fa-pencil m-r-5"></i> Delete</a>
                                                     </div>
                                                 </div>
                                            </td>
                                         </tr>
