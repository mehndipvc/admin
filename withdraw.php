                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr class="holiday-upcoming">
                                            ...
                                            <td>
                                                <button class="btn btn-info" data-toggle="modal" data-target="#edit<?php echo $cnt; ?>">Edit</button>
                                            </td>
                                        </tr>
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="numner" value="<?php echo $val['amount']; ?>" id="amount<?=$val['id']?>" class="form-control" readonly>
                                                            </div>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <select class="form-control" id="status<?=$val['id']?>">
                                                                    ...
                                                                    <option value="Approved" <?= ($val['status']=='Approved')?'selected':'';?>>Approve</option>
                                                                    <option value="Reject" <?= ($val['status']=='Reject')?'selected':'';?>>Reject</option>
                                                                </select>
                                                            </div>
                                                            
                                                            <div class="submit-section">
                                                                <input type="hidden" value="<?php echo $val['user_id']; ?>" id="user_id<?=$val['id']?>">
                                                                <button class="btn btn-primary editSubmit" id="<?=$val['id']?>">Submit</button>
                                                            </div>
                                                            <div class="erMsg<?=$val['id']?> mt-2" style="text-align: center;"></div>
