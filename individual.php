                                ...
                                <tbody>
                                    ...
                                    foreach ($selct as $val) {
                                        ...
                                        if($user_name=='All'){
                                            ...
                                            $user_data = $obj->arr("SELECT name FROM users WHERE user_id='$user_name'");
                                        ...
                                        if($pro_id=='All'){
                                            ...
                                            $pro_data = $obj->arr("SELECT name FROM items WHERE id='$pro_id'");
                                            $pro_id=$pro_data['name'];
                                        }
                                                        ...
                                                        <form id="edit_individual<?php echo $cnt; ?>">
                                                            <div class="form-group">
                                                                ...
                                                                <select name="user_typeEdit" id="<?= $val['id']?>" class="form-control user_typeEdit">
                                                                    ...
                                                                    <option value="CNF" <?php echo ($val['user_type'] == 'CNF') ? 'selected' : ''; ?>>CNF</option>
                                                                    ...
                                                                    <option value="Customer" <?php echo ($val['user_type'] == 'Customer') ? 'selected' : ''; ?>>Customer</option>
                                                                </select>
                                                            </div>
                                                            <div class="form-group">
                                                                ...
                                                                <select name="user_idEdit" class="form-control" id="userList<?= $val['id']?>">
                                                                    ...
                                                                    <?php
                                                                        ...
                                                                        $sel_user = $obj->fetch("SELECT name, user_id FROM users WHERE user_type='$user_type'");
                                                                    ...
                                                                    <?php 
                                                                        ...
                                                                        $user_data = $obj->fetch("SELECT name, user_id FROM users WHERE user_type='$user_type'");
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <select name="product_idEdit" class="form-control product-select" id="product_detEdit<?= $val['id']?>">
                                                                 <?php
                                                                 $cat_id1=$val['category'];
                                                                 $pro_id1=$val['product_id'];
                                                                 $pro_data = $obj->fetch("SELECT id,name FROM items WHERE cat_id='$cat_id1'");
                                                                 if($pro_id1=='All'){
                                                                 ?>
                                                                 <option value="All">All Product</option>
                                                                 <?php
                                                                 foreach($pro_data as $valdata){
                                                                 ?>
                                                                 ...
                                                                 foreach($pro_data as $valdata){
                                                                 ?>
                                                                 <option value="<?=$valdata['id']?>" <?=$valdata['id']==$pro_id1?'selected':'' ?>><?=$valdata['name']?></option>
                                                                 <?php } } ?>
                                                ...
                                                <div class="modal-content">
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="modal-btn delete-action">
                                                            <div class="row">
                                                                <div class="col-6">
                                                                    <button class="btn btn-primary continue-btn delete-indv" id="<?php echo $val['id']; ?>" style="width: 100%;">Delete</button>
                                                                </div>
                                                                <div class="col-6">
...
<script>
    $('.delete-indv').on("click", function(e) {
        let id=$(this).attr('id');
        $.ajax({
