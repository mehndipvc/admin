            ...
            <div class="content container-fluid">
                ...
                <div class="row">
                    <div class="col-sm-12 text-right mb-3">
                        <a href="export-user.php" download class="btn btn-primary"><i class="fa fa-download"></i>
                            Export</a>
                        <a href="tree-view" class="btn btn-primary"><i class="fa fa-users"></i> Tree View</a>
                        <a href="#" data-toggle="modal" data-target="#add_user" class="btn btn-primary"><i
                            ...
                            <table class="table table-striped custom-table mb-0" id="menu-load">
                                ...
                                <tbody>
                                    ...
                                    foreach ($selct as $val) {
                                                ...
                                                <div class="dropdown dropdown-action">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right">
                                                        <a class="dropdown-item" href="#" data-toggle="modal"
                                                            data-target="#edit_modal<?php echo $cnt; ?>"><i
                                                            ...
                                                            <div class="row">
                                                                <div class="col-12" align="center"
                                                                    style="padding-top: 15px;"><span
                                                                        id="preview<?php echo $cnt; ?>"></span></div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <!-- Edit Modal -->
                                        <div class="modal custom-modal fade" id="edit_modal<?php echo $cnt; ?>"
                                            role="dialog">
                                            <div class="modal-dialog modal-dialog-centered">
                                                <div class="modal-content">
                                                    <div class="modal-body">
                                                        <div class="form-body">
                                                            <div class="form-group">
                                                                ...
                                                                <select class="form-control select-search"
                                                                    ...
                                                                    foreach ($fetch_user as $us_val) {
                                                                        ?>
                                                                        <option value="<?= $us_val['id'] ?>"
                                                                            <?= ($us_val['id'] == $val['parent_id']) ? 'selected' : '' ?>>
                                                                            <?= $us_val['name'] ?>
                                                                            [<?php echo $us_val['user_type'] ?>]</option>
                                                                        <?php
                                                                    }
                                                                    ?>
                                                                </select>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control"
                                                                    id="username<?php echo $val['id']; ?>"
                                                                    value="<?= $val['name'] ?>">
                                                                <input type="hidden" id="user_id<?php echo $val['id']; ?>"
                                                                    value="<?= $val['user_id'] ?>">
                                                            </div>
                                                            <div class="form-group">
                                                                <label>Mobile Number</label>
                                                                <input type="text" class="form-control"
                                                                    id="mobile<?php echo $val['id']; ?>"
                                                                    value="<?= $val['mobile'] ?>">
                                                            </div>
                                                            <div class="form-group">
                                                                <label>Email ID</label>
                                                                <input type="email" class="form-control"
                                                                    id="email<?php echo $val['id']; ?>"
                                                                    value="<?= $val['email'] ?>">
                                                            </div>
                                                            <div class="form-group">
                                                                <label>User Type</label><br>
                                                                <select class="form-control" name="user_type"
                                                                    ...
                                                                    <option value="Agent"
                                                                        ...
                                                                        Agent</option>
                                                                    <option value="CNF"
                                                                        <?= ($val['user_type']) == 'CNF' ? 'selected' : '' ?>>CNF
                                                                    </option>
                                                                    <option value="Distributor"
                                                                        <?= ($val['user_type']) == 'Distributor' ? 'selected' : '' ?>>Distributor</option>
                                                                    <option value="Dealer"
                                                                        <?= ($val['user_type']) == 'Dealer' ? 'selected' : '' ?>>
                                                                        Dealer</option>
                                                                    <option value="Customer"
                                                                        <?= ($val['user_type']) == 'Customer' ? 'selected' : '' ?>>
                                                                        Customer</option>
                                                                </select>
                                                            </div>
                                                            <div class="form-group">
                                                            ...
                                                            <div class="form-group">
                                                                <button type="button"
                                                                    class="btn btn-primary continue-btn editSubmit"
                                                                    id="<?php echo $val['id']; ?>">Submit</button>
                                                            </div>
