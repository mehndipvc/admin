                            ...
                            <div class="card-body">
                                <form id="edit_doctor" enctype="multipart/form-data">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="cat_id">
                                            ...
                                            foreach ($cat_fetch as $cval) {
                                                ?>
                                                <option value="<?= $cval['id'] ?>" <?php echo ($cval['id'] == $val['cat_id']) ? 'selected' : ''; ?>><?= $cval['name'] ?>
                                                </option>
                                            <?php } ?>
                                        </select>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" value="<?php echo $val['price']; ?>" type="text"
                                            name="price" />
                                        <span class="qly"></span>
                                    </div>
                                    <div class="form-group">
                                        <label>Qty <span class="text-danger">*</span></label>
                                        <input class="form-control" value="<?php echo $val['quantity']; ?>" type="text"
                                            name="qty" />
                                        <span class="qly"></span>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control summernote"
                                            name="about"><?php echo base64_decode($val['about']); ?></textarea>
                                        <span class="des" style="color: red;"></span>
                                    </div>
                                    <div class="form-group">
                                        <label>Features <span class="text-danger">*</span></label>
                                        <textarea class="form-control summernote"
                                            name="features"><?php echo base64_decode($val['features']); ?></textarea>
                                        <span class="des" style="color: red;"></span>
                                    </div>
                                    <div class="form-group">
                                        <label>Stock</label>
                                        <select class="form-control" name="stock">
                                            <option value="Available" <?= ($val['status'] == 'Available') ? 'selected' : '' ?>>
                                                Available</option>
                                    ...
                                    foreach ($unser as $itemimg) {
                                        ...
                                        <div class="form-group">
                                            ...
                                            <a data-fancybox="image" id="imga" data-src="<?php echo $itemimg->image; ?>"
                                                style="cursor:pointer;">
                                                <img class="thumbnail img<?php echo $to_img; ?>" id="img"
                                                    src="<?php echo $itemimg->image; ?>" style="width: 100px;" />
                                            </a>
                                            <div style="display: flex;justify-content: center;align-items: center;">
                                                <input id="image<?php echo $val['id']; ?>"
                                                    class="form-control file<?php echo $to_img; ?>" type="file"
                                                    style="margin-top: 10px;" name="img[]" />
                                                <button type="button" class="btn btn-danger delete-image"
                                                    data-img-id="<?php echo $to_img; ?>"
                                                    data-image-url="<?php echo $itemimg->image; ?>"><i class="fa fa-remove"
                                                        style="padding-top:8px;"></i></button>
                                            </div>
                                            <input type="hidden" name="old_image[]" value="<?php echo $itemimg->image; ?>"
                                                id="old_image" />
